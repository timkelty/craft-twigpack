...
export default defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: 'https://github.com/nystudio107/craft-twigpack/edit/develop/docs/docs/:path',
    ...
    nav: [
      ...
      {text: 'Issues', link: 'https://github.com/nystudio107/craft-twigpack/issues'},
      {
        text: 'v1', items: [
          ...
          {text: 'v4', link: 'https://nystudio107.com/docs/twigpack/v4/'},
          {text: 'v1', link: '/'},
        ],
      },
    ]
